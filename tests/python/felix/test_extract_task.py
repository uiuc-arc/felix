...
TASK_SKETCHES: Dict[str, List[Union[SketchCodeDesc, SketchCodeRef]]] = {
    ...
    "Const,Const,Const,DepthwiseConv2d,Broadcast(Add...),Elemwise(clip...)": [
        ...
        SketchCodeDesc(
            ...
            # fmt: on
            {
                ...
                "PaddedInput.shared/ax0.ax1.fused.ax2.fused.ax3.fused.outer.outer": "(+ 1 (// (// (+ -1 (* (* sp_0_2:k sp_0_3:k) (* (* (+ (// (// (// -1 sp_3_1:k) sp_2_1:k) sp_1_1:k) (+ 1 (* sp_0_1:k (+ (// (// (// -1 sp_3_0:k) sp_2_0:k) sp_1_0:k) (+ sp_0_0:k 1))))) (+ (* sp_4_1:k sp_4_0:k) (- (* (* sp_1_2:k sp_1_3:k) (* StrideH:s (* sp_1_0:k sp_1_1:k))) StrideH:s))) (* (+ (* sp_5_1:k sp_5_0:k) (- (* (* sp_2_0:k sp_2_1:k) (* sp_2_3:k (* sp_2_2:k StrideW:s))) StrideW:s)) (* sp_3_0:k (* sp_3_3:k (* sp_3_1:k sp_3_2:k))))))) sp_7_0:k) (* sp_2_1:k (* sp_0_1:k (* sp_3_1:k sp_1_1:k)))))",
                "PaddedInput.shared/ax0.ax1.fused.ax2.fused.ax3.fused.inner": "(min (* (+ 1 (+ (// (// (// -1 sp_3_1:k) sp_2_1:k) sp_1_1:k) (* sp_0_1:k (+ sp_0_0:k (+ 1 (// (// (// -1 sp_3_0:k) sp_2_0:k) sp_1_0:k)))))) (* (* (* sp_0_2:k sp_0_3:k) (+ (* sp_4_1:k sp_4_0:k) (- (* (* sp_1_2:k sp_1_3:k) (* StrideH:s (* sp_1_0:k sp_1_1:k))) StrideH:s))) (* (+ (* sp_5_1:k sp_5_0:k) (- (* (* sp_2_2:k sp_2_3:k) (* StrideW:s (* sp_2_0:k sp_2_1:k))) StrideW:s)) (* sp_3_0:k (* sp_3_2:k (* sp_3_1:k sp_3_3:k)))))) sp_7_0:k)",
                "placeholder.shared/ax0.ax1.fused.ax2.fused.ax3.fused.outer.outer": "(+ (// (// (- (* v6:v (* (* sp_3_2:k sp_3_3:k) (* sp_3_1:k sp_3_0:k))) 1) sp_6_0:k) (* (* (* sp_3_1:k sp_2_1:k) sp_1_1:k) sp_0_1:k)) 1)",
    ...
    "Const,Const,TransposeConv2d,Elemwise(tanh...)": [
        SketchCodeDesc(
            ("FU", "SP", "AN", "FSP", "AN", "CA", "CI", "FU", "AN", "PR"),
            {
                "E0": "(- (- (+ (* (- W:s 1) StrideW:s) KW:s) PadW:s) PadW:s)",
                "v1": "(* (* N:s Cout:s) (- (- (+ (* (- H:s 1) StrideH:s) KH:s) PadH:s) PadH:s))",
                "blockIdx.x": "(* v1:v q0:v)",
                "compute/w": "sp_0_0:k",
                "threadIdx.x": "sp_0_0:k",
                "compute/dc.dh.fused.dw.fused.outer": "(+ (// (- (* (* Cin:s KH:s) KW:s) 1) sp_0_0:k) 1)",
            },
        ),
        SketchCodeDesc(
            # fmt: off
            ...
            # fmt: on
            {
                "E0": "N:s",
                "E1": "Cout:s",
                "E2": "(- (- (+ (* (- H:s 1) StrideH:s) KH:s) PadH:s) PadH:s)",
                "E3": "(- (- (+ (* (- W:s 1) StrideW:s) KW:s) PadW:s) PadW:s)",
                "E4": "Cin:s",
                "E5": "KH:s",
                "E6": "KW:s",
                "blockIdx.x": "(* (* (* q0:v q1:v) q2:v) q3:v)",
                "vthread": "(* (* (* sp_0_0:k sp_1_0:k) sp_2_0:k) sp_3_0:k)",
                "threadIdx.x": "(* (* (* sp_3_1:k sp_2_1:k) sp_1_1:k) sp_0_1:k)",
                "compute/b.outer.inner.init": "sp_0_2:k",
                "compute/c.outer.inner.init": "sp_1_2:k",
                "compute/h.outer.inner.init": "sp_2_2:k",
                "compute/w.outer.inner.init": "sp_3_2:k",
                "compute/b.inner.init": "sp_0_3:k",
                "compute/c.inner.init": "sp_1_3:k",
                "compute/h.inner.init": "sp_2_3:k",
                "compute/w.inner.init": "sp_3_3:k",
                "compute/dc.outer.outer": "q4:v",
                "compute/dh.outer.outer": "q5:v",
                "compute/dw.outer.outer": "q6:v",
                "data_pad.shared/ax0.ax1.fused.ax2.fused.ax3.fused.outer.outer": "(+ 1 (// (// (+ -1 (* (+ 1 (+ (// (// (// -1 sp_3_1:k) sp_2_1:k) sp_1_1:k) (+ sp_0_1:k (* sp_0_1:k (+ sp_0_0:k (// (// (// -1 sp_3_0:k) sp_2_0:k) sp_1_0:k)))))) (* (* sp_0_2:k (* sp_0_3:k (* sp_4_1:k sp_4_0:k))) (* (+ -1 (+ (* sp_5_1:k sp_5_0:k) (* sp_2_0:k (* sp_2_1:k (* sp_2_2:k sp_2_3:k))))) (+ -1 (+ (* sp_6_1:k sp_6_0:k) (* sp_3_2:k (* sp_3_3:k (* sp_3_0:k sp_3_1:k))))))))) sp_8_0:k) (* sp_0_1:k (* sp_2_1:k (* sp_3_1:k sp_1_1:k)))))",
                "data_pad.shared/ax0.ax1.fused.ax2.fused.ax3.fused.inner": "(min (* (* sp_0_2:k sp_0_3:k) (* (* (+ 1 (+ (// (// (// -1 sp_3_1:k) sp_2_1:k) sp_1_1:k) (* sp_0_1:k (+ (// (// (// -1 sp_3_0:k) sp_2_0:k) sp_1_0:k) (+ sp_0_0:k 1))))) (* sp_4_1:k sp_4_0:k)) (* (+ (+ -1 (* sp_5_1:k sp_5_0:k)) (* sp_2_0:k (* sp_2_1:k (* sp_2_2:k sp_2_3:k)))) (+ -1 (+ (* sp_6_1:k sp_6_0:k) (* sp_3_1:k (* sp_3_0:k (* sp_3_2:k sp_3_3:k)))))))) sp_8_0:k)",
                "placeholder.shared/ax0.ax1.fused.ax2.fused.ax3.fused.outer.outer": "(+ (// (// (- (* (* (* (* sp_4_1:k sp_4_0:k) (* (* sp_1_2:k sp_1_3:k) (* sp_1_1:k sp_1_0:k))) (* sp_5_1:k sp_5_0:k)) (* sp_6_1:k sp_6_0:k)) 1) sp_7_0:k) (* (* (* sp_3_1:k sp_2_1:k) sp_1_1:k) sp_0_1:k)) 1)",
                "placeholder.shared/ax0.ax1.fused.ax2.fused.ax3.fused.inner": "(min (* (* (* (* sp_4_1:k sp_4_0:k) (* (* sp_1_2:k sp_1_3:k) (* sp_1_1:k sp_1_0:k))) (* sp_5_1:k sp_5_0:k)) (* sp_6_1:k sp_6_0:k)) sp_7_0:k)",
                "placeholder.shared/dc.outer.inner": "sp_4_0:k",
                "placeholder.shared/dh.outer.inner": "sp_5_0:k",
                "placeholder.shared/dw.outer.inner": "sp_6_0:k",
                "placeholder.shared/b.outer.inner": "sp_0_2:k",
                "placeholder.shared/c.outer.inner": "sp_1_2:k",
                "placeholder.shared/h.outer.inner": "sp_2_2:k",
                "placeholder.shared/w.outer.inner": "sp_3_2:k",
                "placeholder.shared/dc.inner": "sp_4_1:k",
                "placeholder.shared/dh.inner": "sp_5_1:k",
                "placeholder.shared/dw.inner": "sp_6_1:k",
                "placeholder.shared/b.inner": "sp_0_3:k",
                "placeholder.shared/c.inner": "sp_1_3:k",
                "placeholder.shared/h.inner": "sp_2_3:k",
                "placeholder.shared/w.inner": "sp_3_3:k",
                "compute/ax0.inner": "(* sp_0_2:k sp_0_3:k)",
                "compute/ax1.inner": "(* sp_1_2:k sp_1_3:k)",
                "compute/ax2.inner": "(* sp_2_2:k sp_2_3:k)",
                "compute/ax3.inner": "(* sp_3_2:k sp_3_3:k)",
            }
        ),
    ],
    ...
    for task, instances in tasks:
        ...
        for in_sk, ref_sk in zip(task.sketches, sketches):
            ...
            for k, expr in vardefs.items():
                print(
                    f"{k}: {ffi.print_expr_preorder(expr)} ; {ffi.print_expr_preorder(ref_sk_.vardefs[k])}"
                )
